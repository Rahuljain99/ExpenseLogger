<?php
  ...
  if (isset($_GET['did'])){
    $i=$_GET['did'];
    $sql="delete from `expenses` where `idd`='$i'";
  ...
  $id=$_SESSION['id'];
  $name=$_SESSION['name'];
  $s="select sum(`expense`) as tot from `expenses` where `ID`='$id'";
...
<head>
  ...
  <title>Expense Logger - Dashboard</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      -->
        ...
        <p>Your total logged expenditure is <?=$r['tot']?></p>
        <hr>
        <!-- DataTables Example -->
        <div class="card mb-3">
          <div class="card-header">
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=$res['Expense']?></td>
                    <td><?=$res['Timestamp']?></td>
                    <td ><a href="index.php?did=<?=$res['idd']?>"><i class="fas fa-times"></i></a>
                      <!--<form method="post">
                        <input type="hidden" name="did" value="<?=$res['idd']?>">
                        <input type="submit" name="" value="Delete">
                      </form>-->
                    </td>
                    <td ><a href="updatex.php?uid=<?=$res['idd']?>"><i class="fas fa-edit"></i></a>
                      <!--<form method="post" action="updatex.php">
                        <input type="hidden" name="uid" value="<?=$res['idd']?>">

<?php
  ...
  $id=$_SESSION['id'];
  $sql="select monthname(`timestamp`) as month,year(`timestamp`) as year,sum(`expense`) as expense from `expenses` where `ID`='$id' group by month";
...
<head>
  ...
  <title>Expense Logger - Monthly Expenses</title>
